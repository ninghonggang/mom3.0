  ...
  <div class="fqc-list">
    <el-card class="search-card">
      <el-form :model="searchForm" inline>
        <el-form-item label="检验单号">
          <el-input v-model="searchForm.fqc_no" placeholder="请输入检验单号" clearable />
        </el-form-item>
    ...
    <el-card>
      <el-table v-loading="loading" :data="tableData">
        <el-table-column prop="fqc_no" label="检验单号" width="140" />
        ...
        <el-table-column prop="rejected_qty" label="不合格数" width="80" />
