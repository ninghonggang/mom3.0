<template>
  <div class="purchase-settlement-list">
    ...
    <el-card class="toolbar-card">
      <el-button type="primary" v-if="hasPermission('fin:purchase:add')" @click="handleAdd">
      ...
      <el-table v-loading="loading" :data="tableData">
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template #default="{ row }">
            ...
            <el-button link type="success" v-if="row.status === 'PENDING' && hasPermission('fin:purchase:approve')" @click="handleApprove(row)">审批</el-button>
          </template>
        </el-table-column>
      </el-table>
...
const loadData = async () => {
  ...
  try {
    ...
    const res = await request.get('/fin/purchase-settlement/list', { params })
...
const handleDetail = (row: any) => ElMessage.info('详情功能开发中')
const handleApprove = (row: any) => ElMessage.info('审批功能开发中')
