...
const handleDelete = async (row: any) => { await ElMessageBox.confirm('确定删除吗？', '提示', { type: 'warning' }); await deleteEquipmentMaintenance(row.id); ElMessage.success('删除成功'); loadData() }
