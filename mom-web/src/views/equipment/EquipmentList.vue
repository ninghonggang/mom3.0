<template>
  <div class="equipment-list">
    ...
    <el-card class="toolbar-card">
      <el-button type="primary" v-if="hasPermission('equipment:list:add')" @click="handleAdd">
    ...
    <el-card>
      <el-table v-loading="loading" :data="tableData">
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template #default="{ row }">
            <el-button link type="primary" v-if="hasPermission('equipment:list:edit')" @click="handleEdit(row)">编辑</el-button>
            <el-button link type="danger" v-if="hasPermission('equipment:list:delete')" @click="handleDelete(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
