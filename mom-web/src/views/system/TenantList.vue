<template>
  <div class="tenant-list">
    ...
    <el-card class="toolbar-card">
      <el-button type="primary" v-if="hasPermission('system:tenant:add')" @click="handleAdd">
        <el-icon><Plus /></el-icon>新增
      </el-button>
      <el-button type="danger" v-if="hasPermission('system:tenant:delete')" :disabled="!selectedRows.length" @click="handleBatchDelete">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template #default="{ row }">
            <el-button link type="primary" v-if="hasPermission('system:tenant:edit')" @click="handleEdit(row)">编辑</el-button>
            <el-button link type="danger" v-if="hasPermission('system:tenant:delete')" @click="handleDelete(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
