<template>
  <div class="warehouse-list">
    ...
    <el-card class="toolbar-card">
      <el-button type="primary" v-if="hasPermission('wms:warehouse:add')" @click="handleAdd">
    ...
    <el-card>
      <el-table v-loading="loading" :data="tableData">
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template #default="{ row }">
            <el-button link type="primary" v-if="hasPermission('wms:warehouse:edit')" @click="handleEdit(row)">编辑</el-button>
            <el-button link type="danger" v-if="hasPermission('wms:warehouse:delete')" @click="handleDelete(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
